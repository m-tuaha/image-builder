...
# IMPORTANT: Add this AFTER the Generate button logic (outside the button block)
# This ensures the image displays persistently
...
# Initialize session state variables at the bottom of your image tab
