...
with tab2:
    ...
    # Get the current refined prompt from session state, or use the text area value
...
st.markdown("---")
st.markdown(
    f"<div style='text-align: center; color: #666; font-size: 0.9rem;'>Powered by OpenAI & Flux Schnell | Built with Streamlit</div>",
    unsafe_allow_html=True
)
